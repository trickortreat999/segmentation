 ...
 * @return none
 */
void runSegmentation(DPUTask *task, bool &is_running, int argc) {
...
int main(int argc, char **argv) {
    ...
    DPUTask *task_conv_1, *task_conv_2;
  	auto total_time=0;
    string file_name = "/home/xilinx/jupyter_notebooks/Cityscapes/video/trafficori.mp4";
    string path = "/home/xilinx/jupyter_notebooks/Cityscapes/video/";
    // Check args
    if (argc == 2) {
...
//  cv::namedWindow( "Segmentation Display", cv::WINDOW_AUTOSIZE );
  ...
  while (is_displaying) {
    Read(is_reading);
    runSegmentation(task_conv_1, is_running_1, argc);
